...
# print("number of nodes ",coauthor_physics.num_nodes)
# print("number of edges ",coauthor_physics.num_edges)
# print("number of features ",coauthor_physics.num_features)
# print("number of classes ",coauthor_physics.num_classes)

# print(coauthor_physics.train_mask.sum(), "  ",coauthor_physics.val_mask.sum(), "   ",coauthor_physics.test_mask.sum())
